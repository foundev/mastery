...
describe('chart helpers', () => {
  ...
  it('renders progress chart with cumulative data', () => {
    ...
    const sessions: GoalSession[] = [
      { goalId: 'g', startTime: Date.UTC(2024, 4, 1), endTime: Date.UTC(2024, 4, 1, 1), duration: 3_600_000 },
      { goalId: 'g', startTime: Date.UTC(2024, 4, 2), endTime: Date.UTC(2024, 4, 2, 2), duration: 7_200_000 }
    ];
  ...
  it('renders analytics charts with summaries', () => {
    ...
    const sessions: GoalSession[] = [
      { goalId: 'g1', startTime: Date.UTC(2024, 4, 1), endTime: Date.UTC(2024, 4, 1, 1), duration: 3_600_000 },
